  ...
  return (
    <div className=" w-full flex justify-center items-center">
      <div className="max-w-4xl mx-auto px-4 py-10">
        <div className=" flex flex-col justify-center items-center gap-3">
          <p>
            Click the button to check a random cocktail recipe for your after
            work
          </p>
          <button
            onClick={() => fetchData()}
            className=" bg-gray-800 text-white px-4 py-2 w-full rounded-md md:w-60"
          >
            Get New Cocktail
          </button>
        </div>
        <div className=" bg-orange-50 p-12 mt-8 rounded-md">
          ...
          <p className=" text-gray-500 text-sm mt-2 italic">
            <b>Glass Type:</b> <span>{strGlass}</span>
          </p>
          <div className=" md:grid md:grid-cols-2 md:gap-8">
        ...
        <div className="text-center p-4 text-black text-xs">
          &copy; {new Date().getFullYear()} Random Cocktail || made by{" "}
          <a
            className=" cursor-pointer underline hover:text-cyan-950"
            href="https://github.com/hassanidris"
            target="_blank"
          >
            Hassen Ahmed
          </a>
